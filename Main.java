...
public class Main {
    public static void main(String[] args) {
        ...
        Auto auto1 = new Auto("A001", "Renault", "Twingo", 2020, 30000, "Gasolina");
        Camioneta camioneta1 = new Camioneta("C001", "Ford", "Ranger", 2022, 80000, 1000);
        Moto moto1 = new Moto("M001", "AKT", "NKD", 2024, 15000, 125);
        ...
        // Si encuentra el vehículo, muestra un error
